...
root under `platform/sandbox/aws-proof` that reuses `platform/terraform/audit`.
...
| Archive bucket | `project-a-sandbox-archive-283077380808` — versioning **Enabled**, SSE-KMS, all public access blocks **true** |
