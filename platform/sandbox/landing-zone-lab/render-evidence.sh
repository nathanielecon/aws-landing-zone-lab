...
ACCOUNT="$(aws sts get-caller-identity --query Account --output text 2>/dev/null || echo '283077380808')"
...
Prior audit-only resources under `platform/sandbox/aws-proof` remain evidence of
