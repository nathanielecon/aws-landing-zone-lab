...
| `platform/terraform/identity/` | same | Success! The configuration is valid. |
| `platform/terraform/network/` | same | Success! The configuration is valid. |
| `platform/terraform/audit/` | same | Success! The configuration is valid. |
| `platform/terraform/organization/` (interface-only) | same | Success! The configuration is valid. |
