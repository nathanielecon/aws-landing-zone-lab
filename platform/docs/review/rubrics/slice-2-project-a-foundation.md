...
- `platform/docs/architecture/overview.md`
- `platform/docs/architecture/accounts.md`
- `platform/docs/decisions/backend.md`
- `platform/docs/decisions/secrets.md`
- `platform/docs/guardrails/organizations.md`
- `platform/terraform/bootstrap/**`
- `platform/terraform/organization/**`
- `platform/terraform/examples/foundation/**`
- `platform/examples/backend/**`
- related task policies `platform/harness/tasks/A-001.json`,
  `A-002.json`
