...
- `platform/terraform/identity/**`, `network/**`, `audit/**`
- `platform/policies/**`
- `platform/environments/**`
- `platform/tests/iam/**`, `governance/**`, `network/**`, `audit/**`,
  `integration/**`
- `platform/docs/architecture/network.md`, `logging.md`
- `platform/docs/guardrails/iam.md`, `policy-validation.md`
- `platform/docs/operations/network-failure-cases.md`, `audit-review.md`,
  `audit-troubleshooting.md`, `baseline-runbook.md`, `cost-and-teardown.md`
- `platform/docs/validation.md`
- `platform/docs/diagrams/aws-landing-zone-network.png`
...
- Environment compositions under `platform/environments/` stay non-secret and
  offline-validatable.
