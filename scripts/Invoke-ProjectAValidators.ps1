...
try {
    ...
    foreach ($validator in $policy.validators) {
        ...
        switch ($id) {
            ...
            'diagram_links' {
                Assert-ExpectedArtifacts;$required=@('aws-landing-zone-lab.png','aws-landing-zone-architecture.png','aws-landing-zone-network.png');$docs=Get-ProjectText @('project-a/README.md','project-a/docs','README.md') @('.md');$errors=@()
