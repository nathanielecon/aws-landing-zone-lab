...
| Live lab account `283077380808` / `us-east-1` | **READY TO APPLY** / `PENDING_APPLY` — designed collapsed identity + network + audit composition; **not** yet cloud-validated as a completed fact |
