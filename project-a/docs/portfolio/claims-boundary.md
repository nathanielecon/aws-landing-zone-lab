...
`project-a/sandbox/landing-zone-lab` was **cloud-validated** in AWS account
...
`project-a/sandbox/landing-zone-lab/EVIDENCE.md` and Actions run
...
The earlier audit-only sandbox (`project-a/sandbox/aws-proof`) remains historical
