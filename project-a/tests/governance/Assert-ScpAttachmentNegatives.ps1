...
# Run: pwsh -NoLogo -NoProfile -File project-a/tests/governance/Assert-ScpAttachmentNegatives.ps1
...
$variablesPath = Join-Path $repoRoot 'project-a/terraform/organization/variables.tf'
